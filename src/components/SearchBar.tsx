...
export default function SearchBar() {
  ...
  return (
    <div className="relative" ref={searchRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-96 max-w-[calc(100vw-2rem)] bg-white rounded-xl border border-gray-200 shadow-medium overflow-hidden z-50 animate-scaleIn">
