...
export const metadata: Metadata = {
  title: "Verktyg för stiftelser | StiftelseGuiden",
  description: "Användbara verktyg för att jämföra stiftelsetyper, beräkna kapital och planera din stiftelse. Kostnadsfria hjälpmedel från StiftelseGuiden.se.",
  keywords: "stiftelseverktyg, stiftelsekapital, jämföra stiftelser, stiftelseberäkning, stiftelseplanering",
};
